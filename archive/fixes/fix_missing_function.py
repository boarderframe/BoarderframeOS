...
def fix_missing_function():
    ...
    functions_to_check = [
        ...
        (
            ...
            'function updateRefreshProgress(message) { console.log("[Progress]", message); }',
        ),
        (
            "showRefreshProgress",
            'function showRefreshProgress(message) { console.log("[Progress Start]", message); }',
        ),
    ]
