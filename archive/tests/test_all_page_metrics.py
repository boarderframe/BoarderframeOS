...
def test_all_pages():
    ...
    try:
        ...
        print(
            f"   Contains Leadership Overview: {'Leadership Overview' in leaders_html}"
        )
        print(
            f"   Has metrics integration note: {'Leaders Metrics Integration' in leaders_html}"
        )
        ...
        print(
            f"   Contains Divisions Overview: {'Divisions Overview' in divisions_html}"
        )
