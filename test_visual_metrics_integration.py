...
def test_visual_integration():
    ...
    print("\n📊 Category Visuals:")
    for category in ['agents', 'leaders', 'departments', 'divisions', 'database', 'servers']:
    ...
    test_depts = ['Executive Leadership', 'Engineering Department', 'Security Department']
    ...
    import re
    gradient_matches = re.findall(r'background: linear-gradient\(135deg, (#[a-fA-F0-9]{6})', summary_html)
