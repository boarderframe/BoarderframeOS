...
def get_agents():
    agents = [
        ...
        {"name": "Eve", "title": "Agent Evolver", "department": "Development", "tier": "specialist",
         "provider": "anthropic", "model": "claude-4-sonnet-20250514", "temperature": 0.7, "max_tokens": 2000},
        {"name": "Bezalel", "title": "Master Programmer", "department": "Development", "tier": "specialist",
         "provider": "anthropic", "model": "claude-4-sonnet-20250514", "temperature": 0.5, "max_tokens": 3000}
    ]
