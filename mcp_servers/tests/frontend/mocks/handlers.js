...
export const handlers = [
  ...
  http.get(`${API_BASE_URL}/api/v1/mcp-servers/`, ({ request }) => {
    const authHeader = request.headers.get('Authorization');
  ...
  http.post(`${API_BASE_URL}/api/v1/mcp-servers/`, ({ request }) => {
    const authHeader = request.headers.get('Authorization');
  ...
  http.get(`${API_BASE_URL}/api/v1/mcp-servers/:id`, ({ request, params }) => {
    const authHeader = request.headers.get('Authorization');
  ...
  http.put(`${API_BASE_URL}/api/v1/mcp-servers/:id`, ({ request }) => {
    const authHeader = request.headers.get('Authorization');
  ...
  http.delete(`${API_BASE_URL}/api/v1/mcp-servers/:id`, ({ request }) => {
    const authHeader = request.headers.get('Authorization');
  ...
  http.get(`${API_BASE_URL}/api/v1/mcp-servers/:id/health`, ({ request, params }) => {
    const authHeader = request.headers.get('Authorization');
  ...
  http.get(`${API_BASE_URL}/api/v1/mcp-servers/:id/tools`, ({ request }) => {
    const authHeader = request.headers.get('Authorization');
  ...
  http.get(`${API_BASE_URL}/api/v1/mcp-servers/:id/resources`, ({ request }) => {
    const authHeader = request.headers.get('Authorization');
