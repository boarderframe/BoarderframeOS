...
DEPARTMENT_VISUALS = {
    ...
    "Software Engineering": {
        "color": BFColors.ENGINEERING,
        "icon": "fa-code",
        "theme": "engineering",
    },
    "Infrastructure": {
        "color": BFColors.INFRASTRUCTURE,
        "icon": "fa-server",
    ...
    # Innovation & Research
    "Innovation Lab": {
        "color": BFColors.INNOVATION,
        "icon": "fa-lightbulb",
        "theme": "innovation",
    },
    "Research & Development": {
        "color": BFColors.RESEARCH,
        "icon": "fa-flask",
        "theme": "research",
    },
    "Product Development": {
...
def populate_visual_metadata():
    ...
    try:
        ...
        for div_id, name in divisions:
            ...
            visual = DIVISION_VISUALS.get(
                div_num,
                {"color": BFColors.INFO, "icon": "fa-layer-group", "theme": "division"},
            )
