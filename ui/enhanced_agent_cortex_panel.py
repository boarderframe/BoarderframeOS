...
from core.agent_development_kit import AgentBlueprint, AgentTemplate, ModelTier, get_adk
    ...
    def _setup_enhanced_routes(self):
                ...
                templates.append(
                    {
                        ...
                        "capabilities": [
                            cap.value for cap in template_config.get("capabilities", [])
                        ],
        ...
        def create_agent_from_template():
            ...
            try:
                ...
                # Save to database
                loop.run_until_complete(self._save_agent_to_db(agent))
        ...
        def create_swarm():
            ...
            return jsonify({"status": "success", "swarm": data["name"]})
